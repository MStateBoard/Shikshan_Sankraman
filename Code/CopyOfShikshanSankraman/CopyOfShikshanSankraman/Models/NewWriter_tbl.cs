...
namespace CopyOfShikshanSankraman.Models
{
    ...
    public partial class NewWriter_tbl
    {
        ...
        [Required(ErrorMessage = "required..")]
        public string LekhachaVishay { get; set; }
        [Required(ErrorMessage = "required..")]
        public string ShaikshanikPatrata { get; set; }
        [Required(ErrorMessage = "required..")]
        public string KaryalayachaPrakar { get; set; }
        [Required(ErrorMessage = "required..")]
        public string VyavasaikSthan { get; set; }
        [Required(ErrorMessage = "required..")]
        public string LekhPrakashanStatus { get; set; }
        [Required(ErrorMessage = "required..")]
        public string Anubhav { get; set; }
        [Required(ErrorMessage = "required..")]
        public string KaryaratSthal { get; set; }
        [Required(ErrorMessage = "required..")]
        public string PrakashitLekh { get; set; }
        [Required(ErrorMessage = "required..")]
        ...
        public string Lekh { get; set; }
        
        public string Font { get; set; }
        public HttpPostedFileBase SamtiPatra1 { get; set; }
        public HttpPostedFileBase Lekh1 { get; set; }
        public HttpPostedFileBase Font1 { get; set; } 
    }
}
