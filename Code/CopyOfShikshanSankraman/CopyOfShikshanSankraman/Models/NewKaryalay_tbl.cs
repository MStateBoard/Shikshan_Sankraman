...
namespace CopyOfShikshanSankraman.Models
{
    ...
    public partial class NewKaryalay_tbl
    {
        public int id { get; set; }
        [Required(ErrorMessage = "required..")]
        public string Vargadar { get; set; }
        [Required(ErrorMessage = "required..")]
        public string SurnameOfHead { get; set; }
        [Required(ErrorMessage = "required..")]
        public string Nav { get; set; }
        [Required(ErrorMessage = "required..")]
        public string VadilancheNav { get; set; }
        [Required(ErrorMessage = "required..")]
        public string KaryalayacheNav { get; set; }
        [Required(ErrorMessage = "required..")]
        ...
        [Required(ErrorMessage = "required..")]
        public Nullable<System.DateTime> VarganiDate { get; set; }
        [Required(ErrorMessage = "required..")]
